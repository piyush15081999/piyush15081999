...
☁️ Cloud & SRE Engineer | Dublin, Ireland  
🎓 MSc Cloud Computing — National College of Ireland  
🏅 Microsoft Azure Administrator (AZ-104) | AWS Partner Accredited

## 🛠️ Tech Stack
- **Cloud:** AWS (EC2, S3, Lambda, RDS, ECS) | Microsoft Azure | GCP (foundational)
- **IaC & DevOps:** Terraform | Ansible | Jenkins | GitHub Actions | GitLab CI/CD
- **Containers:** Docker | Kubernetes
- **Observability:** Prometheus | Grafana | ELK Stack | CloudWatch
- **Languages:** Python | Bash | SQL

## 📌 Featured Projects
- 🔍 [ML-Based Intrusion Detection System](#) — AWS EC2, Flask, CloudWatch, VPC Flow Logs
- 🚀 [Cloud Deployment Platform](#) — AWS CodePipeline, CodeBuild, CodeDeploy, Elastic Beanstalk
